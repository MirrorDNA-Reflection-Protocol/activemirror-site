        ...
        <div className="relative min-h-screen font-sans text-white overflow-x-hidden selection:bg-purple-500/30">
            ...
            <main className="relative z-10 min-h-screen pt-20 pb-8 px-4">
                <div className="max-w-3xl mx-auto">
                    ...
                    >
                        <Link to="/" className="text-xs text-zinc-600 hover:text-amber-400 transition-colors">
                            ← Back to Home
                        </Link>
                    </motion.div>
                </div>
        ...
        return (
            ...
            >
                <SpotlightCard className="p-8 text-center border border-amber-500/20 bg-amber-500/5">
                    <Moon size={48} className="mx-auto mb-4 text-zinc-600" />
    ...
    return (
        ...
        >
            <SpotlightCard className="border border-amber-500/20 bg-black/40 overflow-hidden">
                ...
                {/* Footer */}
                <div className="px-6 py-3 border-t border-white/5 text-xs text-zinc-600 flex justify-between">
        ...
        >
                    ...
                    >
                        <SpotlightCard className="border border-amber-500/30 bg-amber-500/5 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    <label className="text-xs text-zinc-500 mb-1 block">Horizon</label>
                                    <select
            ...
            {predictions.length === 0 ? (
                <SpotlightCard className="p-8 text-center border border-white/10">
                    ...
                    <p className="text-zinc-500">No predictions yet. Make your first one above.</p>
                </SpotlightCard>
            ) : (
                                ...
                                <SpotlightCard className={`border ${status.border} ${status.bg}`}>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {pred.reasoning && (
                                                <p className="text-sm text-zinc-500 mt-1">{pred.reasoning}</p>
                                            )}
                                            <div className="flex flex-wrap gap-2 mt-2">
                                                ...
                                                <span className="px-2 py-0.5 rounded text-xs bg-white/5 text-zinc-500 border border-white/10">
